...
from PyQt5.QtWidgets import QApplication, QWidget, QPushButton, QLineEdit, \
    ...
    QFormLayout, QFrame, QAbstractItemView, QSpacerItem, QSizePolicy, QTabWidget  # noqa
...
def _consumptiontab(self):
    ...
    city_box = QVBoxLayout()  # макет кнопок справа снизу
    city_box.setSizeConstraint(QLayout.SetDefaultConstraint)
    city_box.setContentsMargins(0, 0, 0, 0)
    city_box.setSpacing(0)
    city_box.setObjectName("City")
    ...
    def _setPopulation():
        ...
        # farmer_edit.textChanged.connect(
        #     lambda x: self.action1(x))
    ...
    region1.setStyleSheet("background-color: #ced2bc; font: 12px; \
                          border-radius: 3px;font-style: Roboto")
    region2 = QPushButton(QIcon(':newworld_.webp'), '')
    region2.setStyleSheet("background-color: #ced2bc;font: 12px; \
                          border-radius: 3px;font-style: Roboto")
    region3 = QPushButton(QIcon(':capetrelawney_.webp'), '')
    region3.setStyleSheet("background-color: #ced2bc;font: 12px; \
                          border-radius: 3px;font-style: Roboto")
    region4 = QPushButton(QIcon(':arctic_.webp'), '')
    region4.setStyleSheet("background-color: #ced2bc;font: 12px; \
                          border-radius: 3px;font-style: Roboto")
    region5 = QPushButton(QIcon(':enbesa_.webp'), '')
    region5.setStyleSheet("background-color: #ced2bc;font: 12px; \
                          border-radius: 3px;font-style: Roboto")
    ...
    def _createCity():
        ...
        if x1 == 100:
            ...
            city1.setStyleSheet("background-color: #ced2bc;font: 12px; \
                                border-radius: 3px;font-style: Roboto")
            anothercity = QPushButton('+')
            anothercity.setStyleSheet("background-color: #ced2bc; \
                                      font: 12px; border-radius: \
                                      3px;font-style: Roboto")
            city_box.addWidget(city1)
            city_box.addWidget(anothercity)
            region_city_box.addLayout(city_box)
