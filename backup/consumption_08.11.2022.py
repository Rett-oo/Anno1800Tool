...
def _consumptiontab(self):
    ...
    #     lambda: self.stacked_form_box_1.setCurrentIndex(0))
    self.people_btn.clicked.connect(
        lambda: self.column3_stacked_w("People"))
    self.people_btn.clicked.connect(
        lambda: self.stacked_form_box("People"))
    ...
    #     lambda: self.stacked_form_box_1.setCurrentIndex(1))
    self.house_btn.clicked.connect(
        lambda: self.column3_stacked_w("Home"))
    self.house_btn.clicked.connect(
        lambda: self.stacked_form_box("Home"))
    ...
    def _setPopulation(self, region):
        ...
        for ki in range(5):
            self.stacked_form_count[ki, 0] = stacked_form_box

        print(self.stacked_form_count[ki, 0])
        ...
        if region == "Old_World":
            ...
            for i in people_list:      # заполнение лейблами 1 формы
                ...
                la_le_box.addRow(pic_laybel, edit_)
                edit_.textChanged.connect(self.onTextChanged)
            for i in home_list:      # заполнение лейблами 2 формы
                ...
                edit_.setValidator(val)
                edit_.setMaxLength(4)
                la_le_box2.addRow(pic_laybel, edit_)
                edit_.textChanged.connect(self.onTextChanged)
    ...
    form_1 = _setPopulation(self, "Old_World")
    form_2 = _setPopulation(self, "New_World")
    form_3 = _setPopulation(self, "Cape_Trelawney")
    form_4 = _setPopulation(self, "The_Arctic")
    form_5 = _setPopulation(self, "Enbesa")
    ...
    create_city = _createCity(self, "Old_World")
    create_city2 = _createCity(self, "New_World")
    create_city3 = _createCity(self, "Old_World")
    create_city4 = _createCity(self, "The_Arctic")
    create_city5 = _createCity(self, "Enbesa")
